        ...
        <ScrollArea className="flex-grow overflow-y-auto px-2 pb-4">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6 py-4">
              ...
              {category?.id === 'bushing' ? (
              ...
              ) : category?.id === 'regulating-pt' ? (
                // Regulating PT Form Layout - 2 Column Layout
                <motion.div 
                  ...
                  transition={{ delay: 0.1 }}
                >
                  <h3 className="text-lg font-semibold text-blue-800 mb-4">Regulating PT</h3>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <FormField
                        control={form.control}
                        name="porcelainCondition"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">สภาพ Porcelain</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือกสภาพ Porcelain" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="Good">Good</SelectItem>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input 
                                type="text" 
                                className="border-blue-200 focus-visible:ring-blue-400"
                                placeholder="กรอกการรั่วซึมของน้ำมัน"
                                {...field}
                              />
                            </FormControl>
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">สีของน้ำมัน</FormLabel>
                            <FormControl>
                              <Input 
                                type="text" 
                                className="border-blue-200 focus-visible:ring-blue-400"
                                placeholder="กรอกสีของน้ำมัน"
                                {...field}
                              />
                            </FormControl>
                          </FormItem>
                    ...
                    <div className="space-y-4">
                      ...
                      <FormField
                        control={form.control}
                        name="porcelainCleanliness"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">ความสะอาดของ Porcelain</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือกความสะอาด" />
                                </SelectTrigger>
                                <SelectContent>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">ระดับน้ำมัน</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือกระดับน้ำมัน" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="Normal">Normal</SelectItem>
                                  <SelectItem value="High">High</SelectItem>
              ...
              ) : category?.id === 'radiator-cooling-system' ? (
                // Radiator and Cooling System Form Layout - 6 Rows
                <motion.div 
                  className="p-4 border border-blue-200 rounded-lg bg-blue-50/30"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.1 }}
                >
                  <h3 className="text-lg font-semibold text-blue-800 mb-4">Radiator and Cooling System</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">ความร้อน</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือกระดับความร้อน" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="Normal">Normal</SelectItem>
                                  <SelectItem value="High">High</SelectItem>
                      ...
                      <FormField
                        control={form.control}
                        name="การวัดอัตราการไหลน้ำมัน"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">การวัดอัตราการไหลน้ำมัน</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือกอัตราการไหล" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="Normal">Normal</SelectItem>
                                  <SelectItem value="Low">Low</SelectItem>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <FormField
                        control={form.control}
                        name="ระดับเสียงของพัดลม"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">ระดับเสียงของพัดลม</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือกระดับเสียง" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="Normal">Normal</SelectItem>
                      ...
                      <FormField
                        control={form.control}
                        name="ทดสอบการทำงานOilPump"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">ทดสอบการทำงาน Oil Pump</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือกสถานะการทำงาน" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="Normal">Normal</SelectItem>
                                  <SelectItem value="Abnormal">Abnormal</SelectItem>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input 
                                type="text" 
                                className="border-blue-200 focus-visible:ring-blue-400"
                                placeholder="กรอกข้อมูลสัตว์ที่รัง"
                                {...field}
                              />
                            </FormControl>
                          </FormItem>
                      ...
                      />
                      <div></div> {/* Empty right column for row 6 */}
                    </div>
                  </div>
                </motion.div>
              ) : category?.id === 'thermo-scan' ? (
                // Thermo Scan Form Layout - 6 Rows
                <motion.div 
                  className="p-4 border border-blue-200 rounded-lg bg-blue-50/30"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.1 }}
                >
                  <h3 className="text-lg font-semibold text-blue-800 mb-4">Thermo Scan</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">%Load ขณะตรวจสอบ</FormLabel>
                            <FormControl>
                              <Input 
                                type="text" 
                                className="border-blue-200 focus-visible:ring-blue-400"
                                placeholder="กรอก %Load"
                                {...field}
                              />
                            </FormControl>
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">Temp. Rise Above Normal Temp. (Delta T)</FormLabel>
                            <FormControl>
                              <Input 
                                type="text" 
                                className="border-blue-200 focus-visible:ring-blue-400"
                                placeholder="กรอก Delta T"
                                {...field}
                              />
                            </FormControl>
                          </FormItem>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">Remark</FormLabel>
                            <FormControl>
                              <Input 
                                type="text" 
                                className="border-blue-200 focus-visible:ring-blue-400"
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input 
                                type="text" 
                                className="border-blue-200 focus-visible:ring-blue-400"
                                placeholder="กรอกข้อมูล Foundation"
                                {...field}
                              />
                            </FormControl>
                          </FormItem>
              ...
              ) : category?.id === 'oltc-compartment' ? (
                // OLTC Compartment Form Layout - 2 Column Layout
                <motion.div 
                  className="p-4 border border-blue-200 rounded-lg bg-blue-50/30"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.1 }}
                >
                  <h3 className="text-lg font-semibold text-blue-800 mb-4">OLTC Compartment</h3>
              ...
              ) : category?.id === 'hot-line-oil-filter' ? (
                // Hot Line Oil Filter Form Layout - 2 Column Layout
                <motion.div 
                  className="p-4 border border-blue-200 rounded-lg bg-blue-50/30"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.1 }}
                >
                  <h3 className="text-lg font-semibold text-blue-800 mb-4">Hot Line Oil Filter</h3>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">Pressure</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือก Pressure" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="Normal">Normal</SelectItem>
                                  <SelectItem value="High">High</SelectItem>
                ...
                <motion.div 
                  ...
                  transition={{ delay: 0.1 }}
                >
                  <h3 className="text-lg font-semibold text-blue-800 mb-4">Transformer Control Cabinet</h3>
                ...
                // NGR Form Layout - 2 Column Layout
                <motion.div 
                  className="p-4 border border-blue-200 rounded-lg bg-blue-50/30"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.1 }}
                >
                  <h3 className="text-lg font-semibold text-blue-800 mb-4">NGR</h3>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">สภาพ NGR</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                      ...
                      <FormField
                        control={form.control}
                        name="supportInsulatorMoisture"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">ความชื้นของตู้ Support Insulator</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                    ...
                    <div className="space-y-4">
                      ...
                      <FormField
                        control={form.control}
                        name="ngrFoundationCondition"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">สภาพฐานรองรับ NGR</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือกสภาพฐานรองรับ NGR" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="Good">Good</SelectItem>
                                  <SelectItem value="Fair">Fair</SelectItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-blue-800">Terminal Connector</FormLabel>
                            <FormControl>
                              <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="border-blue-200 focus:ring-blue-400">
                                  <SelectValue placeholder="เลือก Terminal Connector" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="Good">Good</SelectItem>
                                  <SelectItem value="Fair">Fair</SelectItem>
