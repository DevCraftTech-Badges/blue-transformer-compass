...
const oltcCompartmentCategory: Category = {
  id: 'oltc-compartment',
...
const OLTCCompartmentPage: React.FC = () => {
    ...
    <div className="space-y-6 p-6 animate-fade-in">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-2">
          <div className="h-10 w-1.5 bg-emerald-600 rounded-full"></div>
          <div>
            <h1 className="text-2xl font-bold text-emerald-800">
              Visual Inspection - OLTC Compartment
            </h1>
            <p className="text-muted-foreground">การตรวจสอบช่อง OLTC (On Load Tap Changer)</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-emerald-100">
        <VisualInspectionSection 
          title="OLTC Compartment"
          category={oltcCompartmentCategory}
        />
      </div>
    </div>
  );
...
export default OLTCCompartmentPage;