...
const conservatorTankCategory: Category = {
  id: 'conservator-tank',
...
const ConservatorTankPage: React.FC = () => {
    ...
    <div className="space-y-6 p-6 animate-fade-in">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h1 className="text-2xl font-bold text-green-800">
              Visual Inspection - Conservator Tank
            </h1>
            <p className="text-muted-foreground">การตรวจสอบ Conservator Tank ของหม้อแปลง</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-green-100">
        <VisualInspectionSection 
          title="Conservator Tank"
          category={conservatorTankCategory}
        />
      </div>
    </div>
  );
...
export default ConservatorTankPage;