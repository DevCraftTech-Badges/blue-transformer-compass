...
import AutoTransformerInsulationMeasurementTable from '@/components/autoTransformerInsulationMeasurement/AutoTransformerInsulationMeasurementTable';
  ...
  return (
    <Layout>
      <div className="p-6 space-y-6 animate-fade-in">
        ...
        >
          <AutoTransformerInsulationMeasurementTable />
        </motion.div>
      </div>
    </Layout>
  );
